...
export default function (Vue) {
  ...
  Vue.extend = function (extendOptions) {
    ...
    // createClass: return function VueComponent(options) {this._init(options)};
    // name来源于option.name 如export default { name: 'app' }
    // Sub 为一个函数
    ...
    // 将全局Vue.options里面的directives、filters等合并到当前组件的options里面
    ...
    //  config._assetTypes: ["component", "directive", "elementDirective", "filter", "transition", "partial"]
    // 给组件注册vue全局 API方法
