...
/***/ (function(module, exports, __webpack_require__) {
	...
	_instanceVue2['default'].version = '1.0.28';
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * 指定的已有子节点之前插入新的子节点
	 * @param {Element} el 新节点
	 * @param {Element} target 已经有的节点
	 */
	...
	function compileRoot(el, options, contextOptions) {
	  ...
	  if (el.nodeType !== 11) {
	    ...
	    if (names.length) {
	      ...
	      _utilIndex.warn('Attribute' + (plural ? 's ' : ' ') + names.join(', ') + (plural ? ' are' : ' is') + ' ignored on component ' + '<' + componentName + '> because ' + 'the component is a fragment instance: ' + 'http://vuejs.org/guide/components.html#Fragment-Instance');
	    }
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function stringToFragment(templateString, raw) {
	  ...
	  var cacheKey = raw ? templateString : templateString.trim(); //trim() 方法会从一个字符串的两端删除空白字符
	...
	var vFor = {
	  ...
	  bind: function bind() {
	    if (("development") !== 'production' && this.el.hasAttribute('v-if')) {
	      _utilIndex.warn('<' + this.el.tagName.toLowerCase() + ' v-for="' + this.expression + '" v-if="' + this.el.getAttribute('v-if') + '">: ' + 'Using v-if and v-for on the same element is not recommended - ' + 'consider filtering the source Array instead.', this.vm);
	    }
	  ...
	  bind: function bind() {
	    ...
	    this.listener = function () {
	      ...
	      if (_utilIndex.isArray(model)) {
	        ...
	        var i = _utilIndex.indexOf(model, val);
	        if (el.checked) {
	          if (i < 0) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var raf = _utilIndex.inBrowser && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : setTimeout;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function transclude(el, options) {
	  ...
	  // right after this.
	  if (options) {
	    // 把el元素上的所有attributes抽取出来存放在了选项对象的_containerAttrs属性上
